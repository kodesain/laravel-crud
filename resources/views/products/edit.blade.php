    ...
    <div class="card-body">
        ...
        <form method="post" action="{{ route('products.update', $product->prod_id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="prod_description" name="prod_description" value="{{ $product->prod_description }}" required>
            </div>
            <div class="form-group">
                <label for="prod_price">Price</label>
                <input type="number" class="form-control text-right" id="prod_price" name="prod_price" value="{{ $product->prod_price }}" required>
            </div>
            <div class="form-group">
